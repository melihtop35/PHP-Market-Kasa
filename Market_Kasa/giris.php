...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="style/giris.css?v=<?php echo time(); ?>">
</head>
        ...
        <div class="login-screen">
            ...
            <form autocomplete="off" action="islem.php" method="POST">
                <div class="login-form">
                    ...
                    <button href="giris.php" name="giris" id="giris-btn" class="btn"></button>
                </div>
            </form>
            <a href="kayit.php"><button href="kayit.php" id="kaydol-btn" class="btn"></button></a>
            </div>
        </div>
    </div>
</body>
